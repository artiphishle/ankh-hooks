...
test("converts lch to lab correctly", () => {
  ...
  const expecteds = [
    "lab(2, 1.9987816540395795, 0.06979899336525298)",
    "lab(5, 12.855752201347793, 15.320888855988134)",
    "lab(80, 30.641777734985407, 25.71150437527436)",
  ]
...
test("converts xyz to lab correctly", () => {
  ...
  /** @todo Double-check this results and find out about rounding */
  const expecteds = [
    "lab(15.48724439356052, -26.15957502418288, -6.118154353509009)",
    "lab(51.83721156293174, 4.993364781034848, 3.2713111902976655)",
    "lab(76.06926103542808, 6.777038661792911, 4.439852360797958)",
  ]
...
test("converts xyz to rgb correctly", () => {
  ...
  /** @todo Double-check this results and find out about rounding */
  const expecteds = [
    "rgb(134.66087137899075, 120.55120578676606, 118.1746653608519)",
    "rgb(134.66087137899075, 120.55120578676606, 118.1746653608519)",
    "rgb(-520.2041616, 143.9805761889637, 182.95014893323383)",
  ]
...
test("converts lab to xyz correctly", () => {
  ...
  /** @todo Double-check this results and find out about rounding */
  const expecteds = [
    "xyz(28.45441162196072, 18.418651851244416, 3.5333876177528816)",
    "xyz(5.89248204531318e-9, 6.199545535696214e-9, 6.750251165632109e-9)",
    "xyz(131.32638417110175, 76.30335397105253, 7.714536225347496)",
  ]
